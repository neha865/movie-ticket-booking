...
//
//  Created by sree neha,manasa,keerthana,jahnavi
//
...
void insert_details(void);//for inserting movie details
void viewAll(void); // for view all data3
void find(void); // for finding data
void book_ticket(void); //for booking tickets
void old_record(void); //for view old records of users,booked tickets
